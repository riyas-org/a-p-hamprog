...
// --- Safe Defaults for PIC16F1938 ---
// FOSC=INTOSC, WDTE=OFF, MCLRE=ON, LVP=ON
#define SAFE_CFG1_L 0xE4
#define SAFE_CFG1_H 0x09
#define SAFE_CFG2_L 0x13
#define SAFE_CFG2_H 0x16
